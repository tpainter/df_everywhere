...
#
# This file holds the large text messages that are displayed during the program running.
#

def welcome():
    """
    Welcome message that is displayed at the beginning of the program.
    """
